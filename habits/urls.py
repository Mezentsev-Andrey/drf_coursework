...
from habits.views import (GoodHabitListAPIView, HabitCreateAPIView,
                          HabitDestroyView, HabitRetrieveView, HabitUpdateView,
                          NiceHabitListAPIView, OwnerHabitListAPIView)
...
urlpatterns = [
    ...
    path(
        "habit/list/owner/", OwnerHabitListAPIView.as_view(), name="owner_habits-list"
    ),
