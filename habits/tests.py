...
class HabitTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create(
            email="test1@test1.ru", is_superuser=True, is_staff=True, is_active=True
        )
    ...
    def test_list_good_habit(self):
        ...
        response = self.client.get(reverse("habits:good_habits-list"))
    ...
    def test_list_nice_habit(self):
        ...
        response = self.client.get(reverse("habits:nice_habits-list"))
    ...
    def test_list_owner_habit(self):
        ...
        response = self.client.get(reverse("habits:owner_habits-list"))
